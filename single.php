        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <article>
                    ...
                    <figure class="mb-4"><img class="img-fluid rounded" src="<?php echo BASE_URL. '/admin/gambar/' . $post['image'];?>" alt="..." /></figure>
                    <!-- Post content-->
                    <section class="mb-5">
                                ...
                                <div class="row no-gutters">
                                    <div class="col-md-4">
                                        <div class="sidebar-thumb">
                                            <img class="card-img h-80 w-80" src="<?php echo BASE_URL. '/admin/gambar/' . $row['image'];?>" alt="ss" />
                                        </div>
                                    </div>
                                    <div class="col-md-8">
