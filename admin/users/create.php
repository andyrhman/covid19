...
<html lang="en">
    ...
    <head>
        ...
        <title>Bagian Admin - Buat Pengguna</title>
    </head>
        ...
        <div class="admin-kumpul">
            ...
            <div class="admin-content">
                ...
                <div class="content">
                    ...
                    <h2 class="page-title">Buat User</h2>
                    ...
                    <form action="create.php" method="post">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_lengkap" value="<?php echo $nama_lengkap;?>" class="text-input">
                        </div>
                        <div>
                            <label>Email</label>
                        ...
                        <div>
                            <button type="submit" name="create-admin" class="tombol tombol-big">Oke</button>
                        </div>
                    </form>
