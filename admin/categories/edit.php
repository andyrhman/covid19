...
<?php include(ROOT_PATH . "/app/controllers/kategori.php"); 
adminOnly();
?>
...
<html lang="en">
    ...
    <head>
        ...
        <title>Bagian Admin - Edit Kategori</title>
    </head>
            ...
            <div class="admin-content">
                ...
                <div class="content">
                    ...
                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                        ...
                        <div>
                            <button type="submit" name="update-kategori" class="tombol tombol-big">Update Kategori</button>
                        </div>
                    </form>
